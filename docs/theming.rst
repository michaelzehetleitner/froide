...
See the `FragDieSchule.de Theme <https://github.com/okfde/fragdieschule_de>`_ as a real-life example or use the `Basic Froide Theme <https://github.com/okfde/froide-theme>`_ as a starting point.
