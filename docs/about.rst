...
internationalized and configurable, written using Django 1.3 at the time, to power `Frag die Schule <https://fragdieschule.de>`_ which launched in August 2011.
